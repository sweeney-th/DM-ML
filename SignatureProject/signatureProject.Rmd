...
Demonstration of how outliers in the favorites catagory might be detected. Generally speaking, Z = 3+ is a good place to start. If there is an abnormally low or abnormally high amount of variability in the datast, experimentation may be required. For example if 1/3 of your cases are "outliers", you proably need it increase the threshold. A value of 1.5 or 4.5 might be more approprite.
